...
const plans = [
  ...
  },
  {
    ...
    priceYearly: "$12",
    period: "/ month",
    description: "For serious traders managing multiple accounts and chasing funded status.",
    badge: "Most Popular",
    cta: "Get Pro",
    ctaStyle: "gradient",
    features: [
      "Unlimited accounts",
      "All CSV formats + API sync",
      "Advanced equity analytics",
      "Trailing drawdown calculator",
      "Consistency score tracking",
      "Trade replay & journaling",
      "All future prop firm presets",
      "Priority support",
